...
public class ScoreManager : MonoBehaviour 
{
	...
	public void ScoreUpdate(int platforms)
	{
		...
		switch(Int32.Parse(score.text))
		{
			case 25: FindObjectOfType<GoogleManager>().UnlockAchievement(25); break;
			case 50: FindObjectOfType<GoogleManager>().UnlockAchievement(50); break;
			case 100: FindObjectOfType<GoogleManager>().UnlockAchievement(100); break;
			case 200: FindObjectOfType<GoogleManager>().UnlockAchievement(200); break;
			case 500: FindObjectOfType<GoogleManager>().UnlockAchievement(500); break;
			case 750: FindObjectOfType<GoogleManager>().UnlockAchievement(750); break;
			case 1000: FindObjectOfType<GoogleManager>().UnlockAchievement(1000); break;
		...
		if(Int32.Parse(score.text) > PlayerPrefs.GetInt("Highscore"))
		{
			FindObjectOfType<GoogleManager>().DeclareScore(Int32.Parse(score.text));
		}
