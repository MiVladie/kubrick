...
public class ShopManager : MonoBehaviour 
{
	...
	{
		FindObjectOfType<IAPManager>().BuyGems(gems);
	}

	public void BuyNoAds()
	{
		FindObjectOfType<IAPManager>().BuyGems(0);		
	}

	public void BuyGemSuccess(int gems)
	{
		int num = PlayerPrefs.GetInt("Gems");

		PlayerPrefs.SetInt("Gems", num + gems);
